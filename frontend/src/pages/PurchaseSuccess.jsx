        ...
        <>
            ...
            <div className="py-16">
                <div className="max-w-3xl mx-auto bg-white rounded shadow p-8 text-center">
                    ...
                    {orderId && (
                        <div className="mb-4 text-sm text-gray-700">Order created: <strong>{orderId}</strong></div>
                    )}

                    <div className="flex justify-center gap-3">
                        <Link to="/" className="inline-block bg-[#00BBA6] text-white px-4 py-2 rounded hover:bg-[#009f89]">Return Home</Link>
                        <Link to="/my-account" className="inline-block border border-gray-300 px-4 py-2 rounded hover:bg-gray-50">My Account</Link>
                    </div>
                </div>
            </div>
