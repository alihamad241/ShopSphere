                ...
                <div className="col-12">
                    <div className="banner_slider slider_two">
                        <div className="slider_active owl-carousel">
                            ...
                            <div className="single_slider" style={{backgroundImage: 'url(assets/img/slider/slide_4.png)'}}>
                                <div className="slider_content">
                                    <div className="slider_content_inner">
                                        <h1>fashion for you</h1>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br /> Cumque eligendi quia, ratione porro, nemo non.</p>
                        ...
                        <div className="col-lg-3">
                            <div className="single_product">
                                <div className="product_thumb">
                                    <a href="single-product.html"><img src="https://via.placeholder.com/300x400?text=Product+Image" alt="Product" /></a>
                                    <div className="img_icone">
                                        <img src="https://via.placeholder.com/50?text=New" alt="New" />
                                    </div>
                            ...
                            <div className="single_product">
                                <div className="product_thumb">
                                    ...
                                    <div className="hot_img">
                                        <img src="https://via.placeholder.com/50?text=Hot" alt="Hot" />
                                    </div>
                                    <div className="product_action">
                                        <a href="#"> <i className="fa fa-shopping-cart"></i> Add to cart</a>
                                    </div>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="single_banner">
                            <a href="#"><img src="https://via.placeholder.com/400x300?text=Banner+1" alt="Banner" /></a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single_banner">
                            <a href="#"><img src="https://via.placeholder.com/400x300?text=Banner+2" alt="Banner" /></a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single_banner">
                            <a href="#"><img src="https://via.placeholder.com/400x300?text=Banner+3" alt="Banner" /></a>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single_blog">
                            <div className="blog_thumb">
                                <a href="blog-details.html"><img src="https://via.placeholder.com/400x300?text=Blog+Image" alt="Blog" /></a>
                            </div>
                            <div className="blog_content">
                                ...
                                <div className="post_footer">
                                    ...
                                    <div className="Read_more">
                                        <a href="blog-details.html">Read more  <i className="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="brand_active owl-carousel">
                        <div className="col-lg-2">
                            <div className="single_brand">
                                <a href="#"><img src="https://via.placeholder.com/150x80?text=Brand+Logo" alt="Brand" /></a>
                            </div>
                        </div>
                        <div className="col-lg-2">
                            <div className="single_brand">
